...
local quake = lain.util.quake {app=config.TERMINAL, name="Alacritty", followtag=true,
                               height=0.5, width=0.5, horiz="center"}
local keybindings = {}
...
keybindings.globalkeys = awful.util.table.join(
   ...
   awful.key({ modkey,           }, "Return", function () awful.spawn(config.TERMINAL) end,
      {description = descs.OPEN_TERMINAL, group = "launcher"}),
