       ...
       (progn
         ...
         (append-to-list popwin:special-display-config
                         '(("*Help*" :height 20 :position bottom :noselect t)
                           ...
                           ("*Buffer List*" :height 20 :position bottom)
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package skk
       ...
       (progn
         ...
         (setq skk-user-directory (concat (file-name-as-directory init-emacs-local-files) ".ddskk"))

         (defun init-check-jisyo-file (dirname)
           (unless (file-exists-p
                    (concat (file-name-as-directory dirname) "SKK-JISYO.L"))
             ...
             (call-process-shell-command (format "mv ./SKK-JISYO.L %s" (file-name-as-directory dirname)))))

         (init-check-jisyo-file skk-user-directory))
       :config
       (progn
